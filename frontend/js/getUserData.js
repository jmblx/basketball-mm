...
function displayUserProfile(userData) {
    ...
    document.getElementById('userAvatar').src = `http://176.109.110.111/profile/image/path${userData.avatar_path}`;
    console.log(`http://176.109.110.111/profile/image/path${userData.avatar_path}`);
