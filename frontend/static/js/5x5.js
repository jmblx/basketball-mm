var ws;
    ...
    async function loadUserTeams(userId) {
        const response = await fetch(`http://176.109.110.111/profile/user-teams?user_id=${userId}`, {
            method: 'GET'
        });
    ...
    async function checkCaptainship(userId, teamId) {
        const response = await fetch(`http://176.109.110.111/team/check-captainship?user_id=${userId}&team_id=${teamId}`, {
            method: 'GET'
        });
            ...
            myWorker.port.onmessage = function(e) {
                ...
                switch (data.action) {
                    ...
                    case 'matchResearch':
                        ...
                        break;
                    case 'matchStarted':
                        window.location = 'http://www.youtube.com/watch?v=dQw4w9WgXcQ&pp=ygUIcmlja3JvbGw%3D'
                        break;
                    default:
