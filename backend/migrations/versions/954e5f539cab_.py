...
def upgrade() -> None:
    ...
    sa.Column('loser_id', fastapi_users_db_sqlalchemy.generics.GUID(), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('status', sa.Enum('opened', 'pending', 'actived', 'finished', 'cancelled', name='statusevent'), nullable=True),
    ...
    sa.Column('captain_id', fastapi_users_db_sqlalchemy.generics.GUID(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('status', sa.Enum('opened', 'pending', 'actived', 'finished', 'cancelled', name='statusevent'), nullable=False),
